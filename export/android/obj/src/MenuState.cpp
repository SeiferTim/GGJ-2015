...
{
		HX_STACK_FRAME("MenuState","destroy",0xf9ac905e,"MenuState.destroy","MenuState.hx",28,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(28)
		this->super::destroy();
	}
...
Void MenuState_obj::update( Float elaspsed){
{
		HX_STACK_FRAME("MenuState","update",0xf0719b25,"MenuState.update","MenuState.hx",36,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(elaspsed,"elaspsed")
		HX_STACK_LINE(36)
		this->super::update(elaspsed);
	}
return null();
}
