...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("ggj-2015"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
