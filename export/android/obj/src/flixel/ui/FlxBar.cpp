		...
		if (((  (((_g > (int)0))) ? bool((this->_frontFrame->type != (int)2)) : bool(false) ))){
			...
			HX_STACK_LINE(846)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(855)
					::flixel::graphics::tile::FlxDrawTilesItem _g12 = camera->getDrawTilesItem(this->_front->graphic,this->isColored,this->_blendInt,this->antialiasing);		HX_STACK_VAR(_g12,"_g12");
					HX_STACK_LINE(855)
					drawItem = _g12;
					HX_STACK_LINE(857)
