...
{
		HX_STACK_FRAME("flixel.tile.FlxTilemap","drawDebugOnCamera",0x0d929baf,"flixel.tile.FlxTilemap.drawDebugOnCamera","flixel/tile/FlxTilemap.hx",296,0x448feb74)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(326)
		Float rectWidth = (this->_scaledTileWidth * Camera->totalScaleX);		HX_STACK_VAR(rectWidth,"rectWidth");
		HX_STACK_LINE(327)
		Float rectHeight = (this->_scaledTileHeight * Camera->totalScaleY);		HX_STACK_VAR(rectHeight,"rectHeight");
		HX_STACK_LINE(331)
		...
		struct _Function_1_1{
			inline static Float Block( hx::ObjectPtr< ::flixel::tile::FlxTilemap_obj > __this,int &screenXInTiles,int &screenColumns){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tile/FlxTilemap.hx",339,0x448feb74)
				{
					HX_STACK_LINE(339)
					Dynamic Max = (__this->widthInTiles - screenColumns);		HX_STACK_VAR(Max,"Max");
					HX_STACK_LINE(339)
		...
		HX_STACK_LINE(339)
		int _g = ::Std_obj::_int(_Function_1_1::Block(this,screenXInTiles,screenColumns));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(339)
		screenXInTiles = _g;
		struct _Function_1_2{
			inline static Float Block( hx::ObjectPtr< ::flixel::tile::FlxTilemap_obj > __this,int &screenYInTiles,int &screenRows){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/tile/FlxTilemap.hx",340,0x448feb74)
				{
					HX_STACK_LINE(340)
					Dynamic Max = (__this->heightInTiles - screenRows);		HX_STACK_VAR(Max,"Max");
					HX_STACK_LINE(340)
					Float lowerBound;		HX_STACK_VAR(lowerBound,"lowerBound");
					HX_STACK_LINE(340)
		...
		HX_STACK_LINE(340)
		int _g1 = ::Std_obj::_int(_Function_1_2::Block(this,screenYInTiles,screenRows));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(340)
		screenYInTiles = _g1;
		HX_STACK_LINE(342)
				...
				HX_STACK_LINE(351)
				{
					...
					while((true)){
						...
						if (((bool((tile != null())) && bool(tile->visible)))){
							HX_STACK_LINE(357)
							drawX = (this->_helperPoint->x + (hx::Mod(columnIndex,this->widthInTiles) * rectWidth));
							HX_STACK_LINE(358)
							int _g21 = ::Math_obj::floor((Float(columnIndex) / Float(this->widthInTiles)));		HX_STACK_VAR(_g21,"_g21");
							HX_STACK_LINE(358)
							Float _g3 = (_g21 * rectHeight);		HX_STACK_VAR(_g3,"_g3");
							HX_STACK_LINE(358)
							Float _g4 = (this->_helperPoint->y + _g3);		HX_STACK_VAR(_g4,"_g4");
							HX_STACK_LINE(358)
							drawY = _g4;
							HX_STACK_LINE(360)
				...
				HX_STACK_LINE(883)
				{
					...
					while((true)){
						...
						if (((bool((bool((tile != null())) && bool(tile->visible))) && bool((tile->frame->type != (int)2))))){
							...
							HX_STACK_LINE(931)
							::flixel::graphics::tile::FlxDrawTilesItem _g7 = Camera->getDrawTilesItem(this->graphic,isColored,this->_blendInt,null());		HX_STACK_VAR(_g7,"_g7");
							HX_STACK_LINE(931)
							drawItem = _g7;
							HX_STACK_LINE(932)
							{
