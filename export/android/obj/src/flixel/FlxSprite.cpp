...
Void FlxSprite_obj::draw( ){
{
		...
		HX_STACK_LINE(595)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(627)
				::flixel::graphics::tile::FlxDrawTilesItem _g11 = camera->getDrawTilesItem(this->frame->parent,this->isColored,this->_blendInt,this->antialiasing);		HX_STACK_VAR(_g11,"_g11");
				HX_STACK_LINE(627)
				drawItem = _g11;
				HX_STACK_LINE(629)
...
::openfl::_v2::display::BitmapData FlxSprite_obj::get_pixels( ){
	HX_STACK_FRAME("flixel.FlxSprite","get_pixels",0x90b8575f,"flixel.FlxSprite.get_pixels","flixel/FlxSprite.hx",1147,0x0384bffa)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1149)
	if (((this->graphic == null()))){
		HX_STACK_LINE(1151)
		HX_STACK_DO_THROW(HX_CSTRING("FlxSprite object doesn't have any graphic! Please load graphic or call makeGraphic() on the sprite before trying to retrieve its graphic."));
	}
	HX_STACK_LINE(1154)
