...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(529)
		::flixel::input::android::FlxAndroidKeys _g13 = ::flixel::input::android::FlxAndroidKeys_obj::__new();		HX_STACK_VAR(_g13,"_g13");
		HX_STACK_LINE(529)
		::flixel::input::android::FlxAndroidKeys _g14 = ::flixel::FlxG_obj::inputs->add_flixel_input_android_FlxAndroidKeys(_g13);		HX_STACK_VAR(_g14,"_g14");
		HX_STACK_LINE(529)
		::flixel::FlxG_obj::android = _g14;
		HX_STACK_LINE(533)
		::flixel::input::FlxAccelerometer _g15 = ::flixel::input::FlxAccelerometer_obj::__new();		HX_STACK_VAR(_g15,"_g15");
		HX_STACK_LINE(533)
		::flixel::FlxG_obj::accelerometer = _g15;
		HX_STACK_LINE(535)
		::flixel::FlxG_obj::save->bind(HX_CSTRING("flixel"));
		HX_STACK_LINE(537)
		::flixel::system::frontEnds::PluginFrontEnd _g16 = ::flixel::system::frontEnds::PluginFrontEnd_obj::__new();		HX_STACK_VAR(_g16,"_g16");
		HX_STACK_LINE(537)
		::flixel::FlxG_obj::plugins = _g16;
		HX_STACK_LINE(538)
		::flixel::system::frontEnds::VCRFrontEnd _g17 = ::flixel::system::frontEnds::VCRFrontEnd_obj::__new();		HX_STACK_VAR(_g17,"_g17");
		HX_STACK_LINE(538)
		::flixel::FlxG_obj::vcr = _g17;
		HX_STACK_LINE(541)
		::flixel::system::frontEnds::SoundFrontEnd _g18 = ::flixel::system::frontEnds::SoundFrontEnd_obj::__new();		HX_STACK_VAR(_g18,"_g18");
		HX_STACK_LINE(541)
		::flixel::FlxG_obj::sound = _g18;
		HX_STACK_LINE(544)
