...
{
		HX_STACK_FRAME("flixel.input.keyboard.FlxKeyboard","onKeyUp",0xa36f8255,"flixel.input.keyboard.FlxKeyboard.onKeyUp","flixel/input/keyboard/FlxKeyboard.hx",99,0x41882875)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(100)
		this->super::onKeyUp(event);
		HX_STACK_LINE(104)
		if (((  (((::flixel::FlxG_obj::game->debugger != null()))) ? bool(this->inKeyArray(::flixel::FlxG_obj::debugger->toggleKeys,event->keyCode)) : bool(false) ))){
			HX_STACK_LINE(106)
