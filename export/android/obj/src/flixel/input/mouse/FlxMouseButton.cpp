...
Void FlxMouseButton_obj::onDown( Dynamic _){
{
		...
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(58)
		if (((bool((this->ID == (int)-1)) && bool(::flixel::FlxG_obj::debugger->visible)))){
			HX_STACK_LINE(60)
...
{
		HX_STACK_FRAME("flixel.input.mouse.FlxMouseButton","onUp",0x3a027364,"flixel.input.mouse.FlxMouseButton.onUp","flixel/input/mouse/FlxMouseButton.hx",91,0x7fcdf6f7)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(93)
