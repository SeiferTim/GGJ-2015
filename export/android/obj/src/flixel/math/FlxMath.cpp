...
int FlxMath_obj::maxInt( int a,int b){
	HX_STACK_FRAME("flixel.math.FlxMath","maxInt",0x4dbb7033,"flixel.math.FlxMath.maxInt","flixel/math/FlxMath.hx",542,0x837802f8)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(542)
	if (((a > b))){
...
int FlxMath_obj::minInt( int a,int b){
	HX_STACK_FRAME("flixel.math.FlxMath","minInt",0xe253f205,"flixel.math.FlxMath.minInt","flixel/math/FlxMath.hx",550,0x837802f8)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(550)
	if (((a > b))){
...
int FlxMath_obj::absInt( int a){
	HX_STACK_FRAME("flixel.math.FlxMath","absInt",0x118b9f25,"flixel.math.FlxMath.absInt","flixel/math/FlxMath.hx",558,0x837802f8)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(558)
	if (((a > (int)0))){
		HX_STACK_LINE(558)
