...
{
		HX_STACK_FRAME("flixel.math.FlxRect","put",0xa1ed4fa3,"flixel.math.FlxRect.put","flixel/math/FlxRect.hx",81,0x2aef791c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(81)
		if ((!(this->_inPool))){
			HX_STACK_LINE(83)
...
{
		HX_STACK_FRAME("flixel.math.FlxRect","putWeak",0x585fe5bb,"flixel.math.FlxRect.putWeak","flixel/math/FlxRect.hx",94,0x2aef791c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(94)
		if ((this->_weak)){
			HX_STACK_LINE(96)
...
::flixel::math::FlxRect FlxRect_obj::setSize( Float Width,Float Height){
	HX_STACK_FRAME("flixel.math.FlxRect","setSize",0x6cc8c857,"flixel.math.FlxRect.setSize","flixel/math/FlxRect.hx",107,0x2aef791c)
	HX_STACK_THIS(this)
...
::flixel::math::FlxRect FlxRect_obj::setPosition( Float x,Float y){
	HX_STACK_FRAME("flixel.math.FlxRect","setPosition",0xc8aa4b3f,"flixel.math.FlxRect.setPosition","flixel/math/FlxRect.hx",117,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(118)
...
Float Width = __o_Width.Default(0);
Float Height = __o_Height.Default(0);
	HX_STACK_FRAME("flixel.math.FlxRect","set",0xa1ef8876,"flixel.math.FlxRect.set","flixel/math/FlxRect.hx",133,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	HX_STACK_ARG(Width,"Width")
...
::flixel::math::FlxRect FlxRect_obj::copyFrom( ::flixel::math::FlxRect Rect){
	HX_STACK_FRAME("flixel.math.FlxRect","copyFrom",0x003a1e6b,"flixel.math.FlxRect.copyFrom","flixel/math/FlxRect.hx",148,0x2aef791c)
	HX_STACK_THIS(this)
...
::flixel::math::FlxRect FlxRect_obj::copyTo( ::flixel::math::FlxRect Rect){
	HX_STACK_FRAME("flixel.math.FlxRect","copyTo",0x8a77ec3c,"flixel.math.FlxRect.copyTo","flixel/math/FlxRect.hx",163,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Rect,"Rect")
	HX_STACK_LINE(164)
	Rect->x = this->x;
...
::flixel::math::FlxRect FlxRect_obj::copyFromFlash( ::openfl::_v2::geom::Rectangle FlashRect){
	HX_STACK_FRAME("flixel.math.FlxRect","copyFromFlash",0x00426345,"flixel.math.FlxRect.copyFromFlash","flixel/math/FlxRect.hx",178,0x2aef791c)
	HX_STACK_THIS(this)
...
::openfl::_v2::geom::Rectangle FlxRect_obj::copyToFlash( ::openfl::_v2::geom::Rectangle FlashRect){
	HX_STACK_FRAME("flixel.math.FlxRect","copyToFlash",0xf273dfd4,"flixel.math.FlxRect.copyToFlash","flixel/math/FlxRect.hx",193,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(FlashRect,"FlashRect")
	HX_STACK_LINE(194)
	if (((FlashRect == null()))){
...
bool FlxRect_obj::overlaps( ::flixel::math::FlxRect Rect){
	HX_STACK_FRAME("flixel.math.FlxRect","overlaps",0x7d03e5b8,"flixel.math.FlxRect.overlaps","flixel/math/FlxRect.hx",214,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Rect,"Rect")
	HX_STACK_LINE(214)
...
bool FlxRect_obj::containsFlxPoint( ::flixel::math::FlxPoint Point){
	HX_STACK_FRAME("flixel.math.FlxRect","containsFlxPoint",0x79786e69,"flixel.math.FlxRect.containsFlxPoint","flixel/math/FlxRect.hx",225,0x2aef791c)
	HX_STACK_THIS(this)
...
::flixel::math::FlxRect FlxRect_obj::_union( ::flixel::math::FlxRect Rect){
	HX_STACK_FRAME("flixel.math.FlxRect","union",0xcff32ee3,"flixel.math.FlxRect.union","flixel/math/FlxRect.hx",236,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Rect,"Rect")
	HX_STACK_LINE(237)
...
::flixel::math::FlxRect FlxRect_obj::floor( ){
	HX_STACK_FRAME("flixel.math.FlxRect","floor",0x2ba29ba0,"flixel.math.FlxRect.floor","flixel/math/FlxRect.hx",249,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
...
::flixel::math::FlxRect FlxRect_obj::ceil( ){
	HX_STACK_FRAME("flixel.math.FlxRect","ceil",0x05146bb1,"flixel.math.FlxRect.ceil","flixel/math/FlxRect.hx",261,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(262)
...
{
		HX_STACK_FRAME("flixel.math.FlxRect","destroy",0x7f7713ce,"flixel.math.FlxRect.destroy","flixel/math/FlxRect.hx",272,0x2aef791c)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String FlxRect_obj::toString( ){
	HX_STACK_FRAME("flixel.math.FlxRect","toString",0x7047e358,"flixel.math.FlxRect.toString","flixel/math/FlxRect.hx",278,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(280)
...
bool FlxRect_obj::equals( ::flixel::math::FlxRect rect){
	HX_STACK_FRAME("flixel.math.FlxRect","equals",0x8137bdeb,"flixel.math.FlxRect.equals","flixel/math/FlxRect.hx",294,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(rect,"rect")
	...
	struct _Function_1_3{
		inline static bool Block( hx::ObjectPtr< ::flixel::math::FlxRect_obj > __this,::flixel::math::FlxRect &rect){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/math/FlxRect.hx",295,0x2aef791c)
			{
				HX_STACK_LINE(295)
				Float aDiff = 0.0000001;		HX_STACK_VAR(aDiff,"aDiff");
				HX_STACK_LINE(295)
...
::flixel::math::FlxRect FlxRect_obj::intersection( ::flixel::math::FlxRect rect){
	HX_STACK_FRAME("flixel.math.FlxRect","intersection",0x60177af5,"flixel.math.FlxRect.intersection","flixel/math/FlxRect.hx",306,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(rect,"rect")
	HX_STACK_LINE(307)
...
Float FlxRect_obj::get_left( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_left",0xff43d63c,"flixel.math.FlxRect.get_left","flixel/math/FlxRect.hx",326,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(326)
	return this->x;
}
...
Float FlxRect_obj::set_left( Float Value){
	HX_STACK_FRAME("flixel.math.FlxRect","set_left",0xada12fb0,"flixel.math.FlxRect.set_left","flixel/math/FlxRect.hx",330,0x2aef791c)
	HX_STACK_THIS(this)
...
Float FlxRect_obj::get_right( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_right",0xd324ac07,"flixel.math.FlxRect.get_right","flixel/math/FlxRect.hx",337,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(337)
...
Float FlxRect_obj::set_right( Float Value){
	HX_STACK_FRAME("flixel.math.FlxRect","set_right",0xb6759813,"flixel.math.FlxRect.set_right","flixel/math/FlxRect.hx",341,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(342)
...
Float FlxRect_obj::get_top( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_top",0x81be1600,"flixel.math.FlxRect.get_top","flixel/math/FlxRect.hx",348,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(348)
	return this->y;
}
...
Float FlxRect_obj::set_top( Float Value){
	HX_STACK_FRAME("flixel.math.FlxRect","set_top",0x74bfa70c,"flixel.math.FlxRect.set_top","flixel/math/FlxRect.hx",352,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(353)
...
Float FlxRect_obj::get_bottom( ){
	HX_STACK_FRAME("flixel.math.FlxRect","get_bottom",0x04446c60,"flixel.math.FlxRect.get_bottom","flixel/math/FlxRect.hx",359,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(359)
...
Float FlxRect_obj::set_bottom( Float Value){
	HX_STACK_FRAME("flixel.math.FlxRect","set_bottom",0x07c20ad4,"flixel.math.FlxRect.set_bottom","flixel/math/FlxRect.hx",363,0x2aef791c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(364)
