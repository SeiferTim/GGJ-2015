...
{
HX_STACK_FRAME("flixel.math.FlxCallbackPoint","new",0x2af621df,"flixel.math.FlxCallbackPoint.new","flixel/math/FlxPoint.hx",474,0xb3e1cd2c)
HX_STACK_THIS(this)
...
Float Y = __o_Y.Default(0);
	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","set",0x2af9ed21,"flixel.math.FlxCallbackPoint.set","flixel/math/FlxPoint.hx",491,0xb3e1cd2c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
{
...
Float FlxCallbackPoint_obj::set_x( Float Value){
	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","set_x",0x4f288a9a,"flixel.math.FlxCallbackPoint.set_x","flixel/math/FlxPoint.hx",499,0xb3e1cd2c)
	HX_STACK_THIS(this)
...
Float FlxCallbackPoint_obj::set_y( Float Value){
	HX_STACK_FRAME("flixel.math.FlxCallbackPoint","set_y",0x4f288a9b,"flixel.math.FlxCallbackPoint.set_y","flixel/math/FlxPoint.hx",507,0xb3e1cd2c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(508)
...
{
		HX_STACK_FRAME("flixel.math.FlxCallbackPoint","destroy",0xdd08a9f9,"flixel.math.FlxCallbackPoint.destroy","flixel/math/FlxPoint.hx",515,0xb3e1cd2c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(516)
		this->super::destroy();
		HX_STACK_LINE(517)
...
{
		HX_STACK_FRAME("flixel.math.FlxCallbackPoint","put",0x2af7b44e,"flixel.math.FlxCallbackPoint.put","flixel/math/FlxPoint.hx",522,0xb3e1cd2c)
		HX_STACK_THIS(this)
	}
return null();
}
