...
{
HX_STACK_FRAME("flixel.util.FlxTimerManager","new",0x367f0c72,"flixel.util.FlxTimerManager.new","flixel/util/FlxTimer.hx",202,0x0a681e11)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(204)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimerManager","destroy",0xb435da0c,"flixel.util.FlxTimerManager.destroy","flixel/util/FlxTimer.hx",223,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_LINE(224)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimerManager","update",0xf26da137,"flixel.util.FlxTimerManager.update","flixel/util/FlxTimer.hx",236,0x0a681e11)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimerManager","add",0x36752e33,"flixel.util.FlxTimerManager.add","flixel/util/FlxTimer.hx",254,0x0a681e11)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimerManager","remove",0x6ff0b772,"flixel.util.FlxTimerManager.remove","flixel/util/FlxTimer.hx",267,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Timer,"Timer")
		HX_STACK_LINE(267)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimerManager","clear",0xccdb561f,"flixel.util.FlxTimerManager.clear","flixel/util/FlxTimer.hx",275,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_LINE(275)
		::flixel::util::FlxArrayUtil_obj::clearArray_flixel_util_FlxTimer(this->_timers,null());
	}
