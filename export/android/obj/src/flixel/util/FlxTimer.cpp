...
{
		HX_STACK_FRAME("flixel.util.FlxTimer","destroy",0x3b34c9f9,"flixel.util.FlxTimer.destroy","flixel/util/FlxTimer.hx",80,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_LINE(80)
...
int Loops = __o_Loops.Default(1);
	HX_STACK_FRAME("flixel.util.FlxTimer","start",0x9de883a1,"flixel.util.FlxTimer.start","flixel/util/FlxTimer.hx",94,0x0a681e11)
	HX_STACK_THIS(this)
...
Float NewTime = __o_NewTime.Default(-1);
	HX_STACK_FRAME("flixel.util.FlxTimer","reset",0x00a5590e,"flixel.util.FlxTimer.reset","flixel/util/FlxTimer.hx",122,0x0a681e11)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimer","cancel",0x3fc4355b,"flixel.util.FlxTimer.cancel","flixel/util/FlxTimer.hx",135,0x0a681e11)
		HX_STACK_THIS(this)
		HX_STACK_LINE(136)
		this->finished = true;
		HX_STACK_LINE(137)
...
{
		HX_STACK_FRAME("flixel.util.FlxTimer","update",0x0e95cdea,"flixel.util.FlxTimer.update","flixel/util/FlxTimer.hx",153,0x0a681e11)
		HX_STACK_THIS(this)
...
Float FlxTimer_obj::get_timeLeft( ){
	HX_STACK_FRAME("flixel.util.FlxTimer","get_timeLeft",0x3108255e,"flixel.util.FlxTimer.get_timeLeft","flixel/util/FlxTimer.hx",175,0x0a681e11)
	HX_STACK_THIS(this)
	HX_STACK_LINE(175)
...
Float FlxTimer_obj::get_elapsedTime( ){
	HX_STACK_FRAME("flixel.util.FlxTimer","get_elapsedTime",0x36d149ff,"flixel.util.FlxTimer.get_elapsedTime","flixel/util/FlxTimer.hx",180,0x0a681e11)
	HX_STACK_THIS(this)
	HX_STACK_LINE(180)
...
int FlxTimer_obj::get_loopsLeft( ){
	HX_STACK_FRAME("flixel.util.FlxTimer","get_loopsLeft",0x92ed534c,"flixel.util.FlxTimer.get_loopsLeft","flixel/util/FlxTimer.hx",185,0x0a681e11)
	HX_STACK_THIS(this)
	HX_STACK_LINE(185)
...
int FlxTimer_obj::get_elapsedLoops( ){
	HX_STACK_FRAME("flixel.util.FlxTimer","get_elapsedLoops",0x2913a75d,"flixel.util.FlxTimer.get_elapsedLoops","flixel/util/FlxTimer.hx",190,0x0a681e11)
	HX_STACK_THIS(this)
	HX_STACK_LINE(190)
...
Float FlxTimer_obj::get_progress( ){
	HX_STACK_FRAME("flixel.util.FlxTimer","get_progress",0xcf219257,"flixel.util.FlxTimer.get_progress","flixel/util/FlxTimer.hx",195,0x0a681e11)
	HX_STACK_THIS(this)
	HX_STACK_LINE(195)
	if (((this->time > (int)0))){
		HX_STACK_LINE(195)
