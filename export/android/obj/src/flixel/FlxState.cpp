...
bool FlxState_obj::isTransitionNeeded( ){
	HX_STACK_FRAME("flixel.FlxState","isTransitionNeeded",0xb2f69f51,"flixel.FlxState.isTransitionNeeded","flixel/FlxState.hx",139,0xdf96844c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(139)
	return false;
}
...
{
		HX_STACK_FRAME("flixel.FlxState","transitionToState",0x95c64684,"flixel.FlxState.transitionToState","flixel/FlxState.hx",147,0xdf96844c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",155,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",161,0xdf96844c)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",169,0xdf96844c)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",173,0xdf96844c)
		HX_STACK_THIS(this)
...
int FlxState_obj::get_bgColor( ){
	HX_STACK_FRAME("flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",192,0xdf96844c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(192)
...
int FlxState_obj::set_bgColor( int Value){
	HX_STACK_FRAME("flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",197,0xdf96844c)
	HX_STACK_THIS(this)
