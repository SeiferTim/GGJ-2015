...
{
HX_STACK_FRAME("flixel.system.debug.Tracker","new",0xabada902,"flixel.system.debug.Tracker.new","flixel/system/debug/Tracker.hx",149,0x59950a0f)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","destroy",0xc495fe9c,"flixel.system.debug.Tracker.destroy","flixel/system/debug/Tracker.hx",173,0x59950a0f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(174)
...
::flixel::system::debug::TrackerProfile Tracker_obj::findProfileByClass( ::Class ObjectClass){
	HX_STACK_FRAME("flixel.system.debug.Tracker","findProfileByClass",0xa5ca706f,"flixel.system.debug.Tracker.findProfileByClass","flixel/system/debug/Tracker.hx",182,0x59950a0f)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","initWatchEntries",0x70db000f,"flixel.system.debug.Tracker.initWatchEntries","flixel/system/debug/Tracker.hx",195,0x59950a0f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Profile,"Profile")
		HX_STACK_LINE(195)
		if (((Profile != null()))){
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","addExtensions",0xdf917cb7,"flixel.system.debug.Tracker.addExtensions","flixel/system/debug/Tracker.hx",204,0x59950a0f)
		HX_STACK_THIS(this)
		HX_STACK_ARG(Profile,"Profile")
		HX_STACK_LINE(204)
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","addVariables",0xa7820774,"flixel.system.debug.Tracker.addVariables","flixel/system/debug/Tracker.hx",223,0x59950a0f)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","addProfile",0x7ed0d4a6,"flixel.system.debug.Tracker.addProfile","flixel/system/debug/Tracker.hx",57,0x59950a0f)
		HX_STACK_ARG(Profile,"Profile")
		HX_STACK_LINE(57)
		if (((Profile != null()))){
			HX_STACK_LINE(59)
...
::flixel::system::debug::TrackerProfile Tracker_obj::findProfile( Dynamic Object){
	HX_STACK_FRAME("flixel.system.debug.Tracker","findProfile",0x4cea5492,"flixel.system.debug.Tracker.findProfile","flixel/system/debug/Tracker.hx",64,0x59950a0f)
	HX_STACK_ARG(Object,"Object")
	HX_STACK_LINE(65)
	::flixel::system::debug::Tracker_obj::initProfiles();
	HX_STACK_LINE(67)
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","onStateSwitch",0x8ec46b28,"flixel.system.debug.Tracker.onStateSwitch","flixel/system/debug/Tracker.hx",80,0x59950a0f)
		HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("flixel.system.debug.Tracker","initProfiles",0xb7584578,"flixel.system.debug.Tracker.initProfiles","flixel/system/debug/Tracker.hx",85,0x59950a0f)
		HX_STACK_LINE(85)
		if (((::flixel::system::debug::Tracker_obj::profiles == null()))){
			...
			{
				HX_STACK_LINE(92)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::math::FlxPoint >(),Array_obj< ::String >::__new().Add(HX_CSTRING("x")).Add(HX_CSTRING("y")),null());		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(92)
				if (((Profile != null()))){
					HX_STACK_LINE(92)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(93)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::math::FlxRect >(),Array_obj< ::String >::__new().Add(HX_CSTRING("width")).Add(HX_CSTRING("height")),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::math::FlxPoint >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(93)
				if (((Profile != null()))){
					HX_STACK_LINE(93)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(96)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxObject >(),Array_obj< ::String >::__new().Add(HX_CSTRING("velocity")).Add(HX_CSTRING("acceleration")).Add(HX_CSTRING("drag")).Add(HX_CSTRING("angle")).Add(HX_CSTRING("immovable")),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::math::FlxRect >()).Add(hx::ClassOf< ::flixel::FlxBasic >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(96)
				if (((Profile != null()))){
					HX_STACK_LINE(96)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(106)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >(),null(),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxSprite >()).Add(hx::ClassOf< ::flixel::group::FlxTypedGroup >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(106)
				if (((Profile != null()))){
					HX_STACK_LINE(106)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(109)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::FlxCamera >(),Array_obj< ::String >::__new().Add(HX_CSTRING("style")).Add(HX_CSTRING("followLerp")).Add(HX_CSTRING("followLead")).Add(HX_CSTRING("deadzone")).Add(HX_CSTRING("bounds")).Add(HX_CSTRING("zoom")).Add(HX_CSTRING("alpha")).Add(HX_CSTRING("angle")),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::FlxBasic >()).Add(hx::ClassOf< ::flixel::math::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(109)
				if (((Profile != null()))){
					HX_STACK_LINE(109)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(115)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::util::FlxPath >(),Array_obj< ::String >::__new().Add(HX_CSTRING("speed")).Add(HX_CSTRING("angle")).Add(HX_CSTRING("autoCenter")).Add(HX_CSTRING("nodeIndex")).Add(HX_CSTRING("active")).Add(HX_CSTRING("finished")),null());		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(115)
				if (((Profile != null()))){
					HX_STACK_LINE(115)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(120)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::effects::particles::FlxTypedEmitter >(),Array_obj< ::String >::__new().Add(HX_CSTRING("emitting")).Add(HX_CSTRING("frequency")).Add(HX_CSTRING("bounce")),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::group::FlxTypedGroup >()).Add(hx::ClassOf< ::flixel::math::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(120)
				if (((Profile != null()))){
					HX_STACK_LINE(120)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(129)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::flixel::input::touch::FlxTouch >(),Array_obj< ::String >::__new().Add(HX_CSTRING("screenX")).Add(HX_CSTRING("screenY")).Add(HX_CSTRING("touchPointID")).Add(HX_CSTRING("pressed")).Add(HX_CSTRING("justPressed")).Add(HX_CSTRING("justReleased")).Add(HX_CSTRING("isActive")),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::math::FlxPoint >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(129)
				if (((Profile != null()))){
					HX_STACK_LINE(129)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(139)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::display::DisplayObject >(),Array_obj< ::String >::__new().Add(HX_CSTRING("z")).Add(HX_CSTRING("scaleX")).Add(HX_CSTRING("scaleY")).Add(HX_CSTRING("mouseX")).Add(HX_CSTRING("mouseY")).Add(HX_CSTRING("rotationX")).Add(HX_CSTRING("rotationY")).Add(HX_CSTRING("visible")),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::math::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(139)
				if (((Profile != null()))){
					HX_STACK_LINE(139)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(140)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::geom::Point >(),null(),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::math::FlxPoint >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(140)
				if (((Profile != null()))){
					HX_STACK_LINE(140)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
			...
			{
				HX_STACK_LINE(141)
				::flixel::system::debug::TrackerProfile Profile = ::flixel::system::debug::TrackerProfile_obj::__new(hx::ClassOf< ::openfl::_v2::geom::Rectangle >(),null(),Array_obj< ::Dynamic >::__new().Add(hx::ClassOf< ::flixel::math::FlxRect >()));		HX_STACK_VAR(Profile,"Profile");
				HX_STACK_LINE(141)
				if (((Profile != null()))){
					HX_STACK_LINE(141)
					::flixel::system::debug::Tracker_obj::profiles->push(Profile);
