...
Void StatsGraph_obj::update( Float Value,Dynamic Average){
{
		...
		this->minValue = _g1;
		HX_STACK_LINE(128)
		Float _g2 = ::flixel::math::FlxMath_obj::roundDecimal(this->minValue,(int)1);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(128)
		...
		HX_STACK_LINE(129)
		Float _g5 = ::flixel::math::FlxMath_obj::roundDecimal(Value,(int)1);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(129)
		...
		HX_STACK_LINE(130)
		Float _g8 = ::flixel::math::FlxMath_obj::roundDecimal(this->maxValue,(int)1);		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(130)
		...
		HX_STACK_LINE(135)
		Float _g12 = ::flixel::math::FlxMath_obj::roundDecimal(Average,(int)1);		HX_STACK_VAR(_g12,"_g12");
		HX_STACK_LINE(135)
