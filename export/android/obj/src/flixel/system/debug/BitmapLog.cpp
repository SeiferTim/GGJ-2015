...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","createHeaderUI",0x82443d5e,"flixel.system.debug.BitmapLog.createHeaderUI","flixel/system/debug/BitmapLog.hx",85,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(84)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","flixel/system/debug/BitmapLog.hx",97,0xd4331252)
			{
				HX_STACK_LINE(98)
				{
					HX_STACK_LINE(98)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","createFooterUI",0x7f1e51ec,"flixel.system.debug.BitmapLog.createFooterUI","flixel/system/debug/BitmapLog.hx",115,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","destroy",0x2ace25b9,"flixel.system.debug.BitmapLog.destroy","flixel/system/debug/BitmapLog.hx",128,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(129)
		this->super::destroy();
		HX_STACK_LINE(131)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","update",0x5b6d2a2a,"flixel.system.debug.BitmapLog.update","flixel/system/debug/BitmapLog.hx",150,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(150)
		if ((this->_middleMouseDown)){
			HX_STACK_LINE(152)
			::flixel::math::FlxPoint delta;		HX_STACK_VAR(delta,"delta");
			HX_STACK_LINE(152)
			{
				HX_STACK_LINE(152)
			...
			HX_STACK_LINE(153)
			::flixel::math::FlxPoint _g = delta->subtractPoint(this->_lastMousePos);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(153)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","updateSize",0x504b540b,"flixel.system.debug.BitmapLog.updateSize","flixel/system/debug/BitmapLog.hx",160,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(161)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","resize",0xdce2fe15,"flixel.system.debug.BitmapLog.resize","flixel/system/debug/BitmapLog.hx",167,0xd4331252)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(172)
		int newWidth = ::Std_obj::_int(_g2);		HX_STACK_VAR(newWidth,"newWidth");
		HX_STACK_LINE(173)
		Float _g3 = this->_canvasBitmap->get_y();		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(173)
		...
		HX_STACK_LINE(173)
		int newHeight = ::Std_obj::_int(_g6);		HX_STACK_VAR(newHeight,"newHeight");
		HX_STACK_LINE(175)
		if (((bool((newWidth > (int)0)) && bool((newHeight > (int)0))))){
			HX_STACK_LINE(177)
			::openfl::_v2::display::BitmapData _g7 = ::openfl::_v2::display::BitmapData_obj::__new(newWidth,newHeight,true,(int)0,null());		HX_STACK_VAR(_g7,"_g7");
			HX_STACK_LINE(177)
			this->_canvasBitmap->set_bitmapData(_g7);
			HX_STACK_LINE(178)
			this->refreshCanvas(this->_curIndex);
		}
		HX_STACK_LINE(181)
		Float _g8 = this->_header->get_width();		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(181)
		Float _g9 = this->_ui->get_width();		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(181)
		Float _g10 = (_g8 - _g9);		HX_STACK_VAR(_g10,"_g10");
		HX_STACK_LINE(181)
		Float _g11 = (_g10 + (int)43);		HX_STACK_VAR(_g11,"_g11");
		HX_STACK_LINE(181)
		this->_ui->set_x(_g11);
		HX_STACK_LINE(183)
		this->_footer->set_width(this->_width);
		HX_STACK_LINE(184)
		Float _g12 = this->_footer->get_height();		HX_STACK_VAR(_g12,"_g12");
		HX_STACK_LINE(184)
		Float _g13 = (this->_height - _g12);		HX_STACK_VAR(_g13,"_g13");
		HX_STACK_LINE(184)
		this->_footer->set_y(_g13);
		HX_STACK_LINE(186)
		this->resizeTexts();
	}
return null();
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","resizeTexts",0xdbc990d1,"flixel.system.debug.BitmapLog.resizeTexts","flixel/system/debug/BitmapLog.hx",190,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(191)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","next",0xbc832ed4,"flixel.system.debug.BitmapLog.next","flixel/system/debug/BitmapLog.hx",211,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(212)
		{
			HX_STACK_LINE(212)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","previous",0x9c626a98,"flixel.system.debug.BitmapLog.previous","flixel/system/debug/BitmapLog.hx",220,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(221)
		{
			HX_STACK_LINE(221)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","resetSettings",0x02f1fbd1,"flixel.system.debug.BitmapLog.resetSettings","flixel/system/debug/BitmapLog.hx",226,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(227)
		this->set_zoom((int)1);
		HX_STACK_LINE(228)
...
::String name = __o_name.Default(HX_CSTRING(""));
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","add",0xe9d8df60,"flixel.system.debug.BitmapLog.add","flixel/system/debug/BitmapLog.hx",235,0xd4331252)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(name,"name")
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::openfl::_v2::display::BitmapData &_g,::String &name){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/BitmapLog.hx",241,0xd4331252)
				{
...
int Index = __o_Index.Default(-1);
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","clearAt",0xb18ce09f,"flixel.system.debug.BitmapLog.clearAt","flixel/system/debug/BitmapLog.hx",250,0xd4331252)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","clear",0xe56f6c8c,"flixel.system.debug.BitmapLog.clear","flixel/system/debug/BitmapLog.hx",268,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(269)
		{
			HX_STACK_LINE(269)
...
bool BitmapLog_obj::refreshCanvas( Dynamic Index){
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","refreshCanvas",0xfd928b12,"flixel.system.debug.BitmapLog.refreshCanvas","flixel/system/debug/BitmapLog.hx",282,0xd4331252)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Index,"Index")
	HX_STACK_LINE(283)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","refreshTexts",0xd91a3a2c,"flixel.system.debug.BitmapLog.refreshTexts","flixel/system/debug/BitmapLog.hx",328,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_LINE(329)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","drawBoundingBox",0xb05c8722,"flixel.system.debug.BitmapLog.drawBoundingBox","flixel/system/debug/BitmapLog.hx",340,0xd4331252)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(344)
		Float offset = (Float((int)1) / Float(this->zoom));		HX_STACK_VAR(offset,"offset");
		HX_STACK_LINE(345)
		int _g = bitmap->get_width();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(345)
		Float _g1 = (_g + offset);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(345)
		int _g2 = bitmap->get_height();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(345)
		Float _g3 = (_g2 + offset);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(345)
		gfx->drawRect(-(offset),-(offset),_g1,_g3);
	}
return null();
}
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","onMouseWheel",0x77c9bd16,"flixel.system.debug.BitmapLog.onMouseWheel","flixel/system/debug/BitmapLog.hx",349,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(350)
		{
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","onMiddleDown",0x0e5d5b37,"flixel.system.debug.BitmapLog.onMiddleDown","flixel/system/debug/BitmapLog.hx",355,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(356)
...
{
		HX_STACK_FRAME("flixel.system.debug.BitmapLog","onMiddleUp",0x6933f9f0,"flixel.system.debug.BitmapLog.onMiddleUp","flixel/system/debug/BitmapLog.hx",362,0xd4331252)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(362)
		this->_middleMouseDown = false;
...
Float BitmapLog_obj::set_zoom( Float Value){
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","set_zoom",0xf7c26671,"flixel.system.debug.BitmapLog.set_zoom","flixel/system/debug/BitmapLog.hx",366,0xd4331252)
	HX_STACK_THIS(this)
...
::openfl::_v2::display::BitmapData BitmapLog_obj::get__canvas( ){
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","get__canvas",0x3be08acd,"flixel.system.debug.BitmapLog.get__canvas","flixel/system/debug/BitmapLog.hx",376,0xd4331252)
	HX_STACK_THIS(this)
	HX_STACK_LINE(376)
...
Dynamic BitmapLog_obj::get__curEntry( ){
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","get__curEntry",0x0843d007,"flixel.system.debug.BitmapLog.get__curEntry","flixel/system/debug/BitmapLog.hx",381,0xd4331252)
	HX_STACK_THIS(this)
	HX_STACK_LINE(381)
...
::openfl::_v2::display::BitmapData BitmapLog_obj::get__curBitmap( ){
	HX_STACK_FRAME("flixel.system.debug.BitmapLog","get__curBitmap",0x1efb5aba,"flixel.system.debug.BitmapLog.get__curBitmap","flixel/system/debug/BitmapLog.hx",386,0xd4331252)
	HX_STACK_THIS(this)
	HX_STACK_LINE(386)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(BitmapLog_obj,_point),HX_CSTRING("_point")},
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(BitmapLog_obj,_lastMousePos),HX_CSTRING("_lastMousePos")},
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(BitmapLog_obj,_curMouseOffset),HX_CSTRING("_curMouseOffset")},
