...
int Size = __o_Size.Default(12);
	HX_STACK_FRAME("flixel.system.debug.DebuggerUtil","createTextField",0x34b9b52e,"flixel.system.debug.DebuggerUtil.createTextField","flixel/system/debug/DebuggerUtil.hx",26,0x13434d32)
	HX_STACK_ARG(X,"X")
	HX_STACK_ARG(Y,"Y")
	...
	HX_STACK_ARG(Size,"Size")
{
		...
		HX_STACK_LINE(38)
		::openfl::_v2::text::TextFormat _g = ::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEBUGGER,Size,(int(Color) & int((int)16777215)),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(38)
		tf->set_defaultTextFormat(_g);
		HX_STACK_LINE(39)
		tf->set_alpha((Float(((int((int(Color) >> int((int)24))) & int((int)255)))) / Float((int)255)));
		HX_STACK_LINE(40)
		return tf;
	}
}
