...
HX_STACK_ARG(Debugger,"Debugger")
{
	...
	HX_STACK_LINE(59)
	::flixel::system::ui::FlxSystemButton _g1 = Debugger->addButton(::flixel::system::debug::FlxButtonAlignment_obj::MIDDLE,_g,::flixel::FlxG_obj::resetState_dyn(),null(),null());		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(59)
	this->restartBtn = _g1;
	HX_STACK_LINE(64)
	...
	HX_STACK_LINE(64)
	::flixel::system::ui::FlxSystemButton _g3 = Debugger->addButton(::flixel::system::debug::FlxButtonAlignment_obj::MIDDLE,_g2,::flixel::FlxG_obj::vcr->pause_dyn(),null(),null());		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(64)
	...
	HX_STACK_LINE(65)
	::flixel::system::ui::FlxSystemButton _g5 = Debugger->addButton(::flixel::system::debug::FlxButtonAlignment_obj::MIDDLE,_g4,this->onStep_dyn(),null(),null());		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(65)
	this->stepBtn = _g5;
}
;
