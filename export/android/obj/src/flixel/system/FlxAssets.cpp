...
{
		HX_STACK_FRAME("flixel.system.FlxAssets","init",0x4cb026b6,"flixel.system.FlxAssets.init","flixel/system/FlxAssets.hx",115,0xd3ac1356)
		HX_STACK_LINE(116)
...
::openfl::_v2::display::BitmapData FlxAssets_obj::getBitmapFromClass( ::Class source){
	HX_STACK_FRAME("flixel.system.FlxAssets","getBitmapFromClass",0x223d9eaf,"flixel.system.FlxAssets.getBitmapFromClass","flixel/system/FlxAssets.hx",192,0xd3ac1356)
	HX_STACK_ARG(source,"source")
	HX_STACK_LINE(192)
	return ::Type_obj::createInstance(source,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0)));
}
...
::openfl::_v2::display::BitmapData FlxAssets_obj::resolveBitmapData( Dynamic Graphic){
	HX_STACK_FRAME("flixel.system.FlxAssets","resolveBitmapData",0x02df705f,"flixel.system.FlxAssets.resolveBitmapData","flixel/system/FlxAssets.hx",206,0xd3ac1356)
	...
	if ((::Std_obj::is(Graphic,hx::ClassOf< ::openfl::_v2::display::BitmapData >()))){
		...
		if ((::Std_obj::is(Graphic,hx::ClassOf< ::Class >()))){
			HX_STACK_LINE(213)
			return ::Type_obj::createInstance(Graphic,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0)));
		}
		else{
			HX_STACK_LINE(215)
...
::String FlxAssets_obj::resolveKey( Dynamic Graphic,::String Key){
	HX_STACK_FRAME("flixel.system.FlxAssets","resolveKey",0xd790f639,"flixel.system.FlxAssets.resolveKey","flixel/system/FlxAssets.hx",235,0xd3ac1356)
	HX_STACK_ARG(Graphic,"Graphic")
...
::openfl::_v2::media::Sound FlxAssets_obj::getSound( ::String id){
	HX_STACK_FRAME("flixel.system.FlxAssets","getSound",0x306e52ff,"flixel.system.FlxAssets.getSound","flixel/system/FlxAssets.hx",258,0xd3ac1356)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(259)
...
::flixel::graphics::frames::FlxAtlasFrames FlxAssets_obj::getVirtualInputFrames( ){
	HX_STACK_FRAME("flixel.system.FlxAssets","getVirtualInputFrames",0xfe1716d5,"flixel.system.FlxAssets.getVirtualInputFrames","flixel/system/FlxAssets.hx",269,0xd3ac1356)
	HX_STACK_LINE(270)
