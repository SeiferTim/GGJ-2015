...
Void BitmapLogFrontEnd_obj::viewCache( ){
{
		...
		::flixel::FlxG_obj::game->debugger->bitmapLog->clear();
		HX_STACK_LINE(44)
		for(::cpp::FastIterator_obj< ::flixel::graphics::FlxGraphic > *__it = ::cpp::CreateFastIterator< ::flixel::graphics::FlxGraphic >(::flixel::FlxG_obj::bitmap->_cache->iterator());  __it->hasNext(); ){
