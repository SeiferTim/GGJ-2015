...
{
		HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","removeFromOpenFLCache",0x35197031,"flixel.system.frontEnds.BitmapFrontEnd.removeFromOpenFLCache","flixel/system/frontEnds/BitmapFrontEnd.hx",349,0x91a05ae2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(key,"key")
		HX_STACK_LINE(349)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","removeIfNoUse",0x6b036552,"flixel.system.frontEnds.BitmapFrontEnd.removeIfNoUse","flixel/system/frontEnds/BitmapFrontEnd.hx",357,0x91a05ae2)
		HX_STACK_THIS(this)
		HX_STACK_ARG(graphic,"graphic")
		struct _Function_1_1{
		...
		HX_STACK_LINE(357)
		if (((  (((  (((graphic != null()))) ? bool(_Function_1_1::Block(graphic)) : bool(false) ))) ? bool(!(graphic->persist)) : bool(false) ))){
			HX_STACK_LINE(359)
			this->remove(graphic);
		}
	}
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","clearCache",0xad367388,"flixel.system.frontEnds.BitmapFrontEnd.clearCache","flixel/system/frontEnds/BitmapFrontEnd.hx",368,0x91a05ae2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(369)
		::flixel::graphics::FlxGraphic obj;		HX_STACK_VAR(obj,"obj");
		HX_STACK_LINE(371)
...
{
		HX_STACK_FRAME("flixel.system.frontEnds.BitmapFrontEnd","clearUnused",0x9cfedd10,"flixel.system.frontEnds.BitmapFrontEnd.clearUnused","flixel/system/frontEnds/BitmapFrontEnd.hx",391,0x91a05ae2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(392)
		::flixel::graphics::FlxGraphic obj;		HX_STACK_VAR(obj,"obj");
		HX_STACK_LINE(394)
				...
				::String key = __it->next();
				{
					...
					struct _Function_3_1{
						inline static bool Block( ::flixel::graphics::FlxGraphic &obj){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/frontEnds/BitmapFrontEnd.hx",399,0x91a05ae2)
							{
								HX_STACK_LINE(399)
