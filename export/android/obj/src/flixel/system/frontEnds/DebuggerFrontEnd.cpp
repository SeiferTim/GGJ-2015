...
::flixel::system::debug::Window DebuggerFrontEnd_obj::track( Dynamic Object,::String WindowTitle){
	...
	if (((_g == (int)-1))){
		...
		if (((profile == null()))){
			...
			HX_STACK_LINE(95)
			::String _g7 = (HX_CSTRING("Could not find a tracking profile for object of class '") + _g6);		HX_STACK_VAR(_g7,"_g7");
			HX_STACK_LINE(95)
			HX_STACK_DO_THROW((_g7 + HX_CSTRING("'.")));
			HX_STACK_LINE(96)
			return null();
		}
		else{
...
bool DebuggerFrontEnd_obj::set_visible( bool Value){
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","set_visible",0xfdfb51d4,"flixel.system.frontEnds.DebuggerFrontEnd.set_visible","flixel/system/frontEnds/DebuggerFrontEnd.hx",151,0x2ebb4b30)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(153)
