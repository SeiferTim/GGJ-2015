...
::flixel::input::android::FlxAndroidKeys InputFrontEnd_obj::add_flixel_input_android_FlxAndroidKeys( ::flixel::input::android::FlxAndroidKeys Input){
	HX_STACK_FRAME("flixel.system.frontEnds.InputFrontEnd","add_flixel_input_android_FlxAndroidKeys",0x46ee914f,"flixel.system.frontEnds.InputFrontEnd.add_flixel_input_android_FlxAndroidKeys","flixel/system/frontEnds/InputFrontEnd.hx",30,0x759f67bd)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(32)
	{
		...
		while((true)){
			...
			struct _Function_3_1{
				inline static bool Block( ::flixel::input::android::FlxAndroidKeys &Input,::flixel::input::IFlxInputManager &input){
