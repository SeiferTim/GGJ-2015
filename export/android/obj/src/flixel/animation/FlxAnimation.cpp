	...
	HX_STACK_ARG(Frame,"Frame")
{
		...
		if (((bool((bool((this->delay <= (int)0)) || bool((bool((Frame > numFramesMinusOne)) && bool(!(this->reversed)))))) || bool((bool((Frame < (int)0)) && bool(this->reversed)))))){
			...
			{
				HX_STACK_LINE(126)
				::flixel::animation::FlxAnimationController _this = this->parent;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(126)
...
{
		HX_STACK_FRAME("flixel.animation.FlxAnimation","update",0x6f4f32a9,"flixel.animation.FlxAnimation.update","flixel/animation/FlxAnimation.hx",156,0x660bc6ae)
		HX_STACK_THIS(this)
...
::flixel::animation::FlxBaseAnimation FlxAnimation_obj::clone( ::flixel::animation::FlxAnimationController Parent){
	HX_STACK_FRAME("flixel.animation.FlxAnimation","clone",0x4847dabd,"flixel.animation.FlxAnimation.clone","flixel/animation/FlxAnimation.hx",187,0x660bc6ae)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Parent,"Parent")
	HX_STACK_LINE(187)
...
int FlxAnimation_obj::set_frameRate( int value){
	HX_STACK_FRAME("flixel.animation.FlxAnimation","set_frameRate",0x8699eef0,"flixel.animation.FlxAnimation.set_frameRate","flixel/animation/FlxAnimation.hx",191,0x660bc6ae)
	HX_STACK_THIS(this)
...
int FlxAnimation_obj::set_curFrame( int Frame){
	HX_STACK_FRAME("flixel.animation.FlxAnimation","set_curFrame",0x46812eaa,"flixel.animation.FlxAnimation.set_curFrame","flixel/animation/FlxAnimation.hx",202,0x660bc6ae)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Frame,"Frame")
	HX_STACK_LINE(203)
	int numFramesMinusOne = (this->_frames->length - (int)1);		HX_STACK_VAR(numFramesMinusOne,"numFramesMinusOne");
...
int FlxAnimation_obj::get_numFrames( ){
	HX_STACK_FRAME("flixel.animation.FlxAnimation","get_numFrames",0x65f5f5c3,"flixel.animation.FlxAnimation.get_numFrames","flixel/animation/FlxAnimation.hx",231,0x660bc6ae)
	HX_STACK_THIS(this)
	HX_STACK_LINE(231)
