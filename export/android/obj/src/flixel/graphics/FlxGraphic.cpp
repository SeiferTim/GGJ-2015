...
::openfl::_v2::display::BitmapData FlxGraphic_obj::getBitmapFromSystem( ){
	...
	if (((this->assetsClass != null()))){
		HX_STACK_LINE(579)
		::openfl::_v2::display::BitmapData _g = ::Type_obj::createInstance(this->assetsClass,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0)));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(579)
		newBitmap = _g;
	}
	else{
	...
	HX_STACK_ARG(Cache,"Cache")
{
		...
		if ((!(Cache))){
			HX_STACK_LINE(76)
			::openfl::_v2::display::BitmapData _g = ::Type_obj::createInstance(Source,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0)));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(76)
			bitmap = _g;
			HX_STACK_LINE(77)
			return ::flixel::graphics::FlxGraphic_obj::createGraphic(bitmap,Key,Unique,Cache);
		...
		HX_STACK_LINE(88)
		::openfl::_v2::display::BitmapData _g2 = ::Type_obj::createInstance(Source,Dynamic( Array_obj<Dynamic>::__new().Add((int)0).Add((int)0)));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(88)
		bitmap = _g2;
		HX_STACK_LINE(89)
