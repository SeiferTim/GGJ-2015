...
::flixel::graphics::atlas::FlxNode FlxAtlas_obj::addNode( Dynamic Graphic,::String Key){
	...
	if (((key == null()))){
		HX_STACK_LINE(161)
		HX_STACK_DO_THROW(HX_CSTRING("addNode can't find the key for specified bitmapdata. Please provide not null value as a Key argument."));
		HX_STACK_LINE(163)
		return null();
	}
	HX_STACK_LINE(166)
	...
	if (((data == null()))){
		HX_STACK_LINE(174)
		::String _g1 = ::Std_obj::string(Graphic);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(174)
		::String _g2 = (HX_CSTRING("addNode can't find bitmapdata with specified key: ") + _g1);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(174)
		HX_STACK_DO_THROW((_g2 + HX_CSTRING(". Please provide valid value.")));
		HX_STACK_LINE(176)
		return null();
	}
	HX_STACK_LINE(180)
...
::flixel::graphics::atlas::FlxNode FlxAtlas_obj::insertFirstNodeInRoot( ::openfl::_v2::display::BitmapData data,::String key){
	...
	if (((this->root->left == null()))){
		...
		if (((bool((bool((this->maxWidth > (int)0)) && bool((rootWidth > this->maxWidth)))) || bool((bool((this->maxHeight > (int)0)) && bool((rootHeight > this->maxHeight))))))){
			HX_STACK_LINE(357)
			int _g6 = data->get_width();		HX_STACK_VAR(_g6,"_g6");
			HX_STACK_LINE(357)
			::String _g7 = (((HX_CSTRING("Can't insert node ") + key) + HX_CSTRING(" with the size of (")) + _g6);		HX_STACK_VAR(_g7,"_g7");
			HX_STACK_LINE(357)
			::String _g8 = (_g7 + HX_CSTRING("; "));		HX_STACK_VAR(_g8,"_g8");
			HX_STACK_LINE(357)
			int _g9 = data->get_height();		HX_STACK_VAR(_g9,"_g9");
			HX_STACK_LINE(357)
			::String _g10 = (_g8 + _g9);		HX_STACK_VAR(_g10,"_g10");
			HX_STACK_LINE(357)
			::String _g11 = (_g10 + HX_CSTRING(") in atlas "));		HX_STACK_VAR(_g11,"_g11");
			HX_STACK_LINE(357)
			::String _g12 = (_g11 + this->name);		HX_STACK_VAR(_g12,"_g12");
			HX_STACK_LINE(357)
			::String _g13 = (_g12 + HX_CSTRING(" with the max size of ("));		HX_STACK_VAR(_g13,"_g13");
			HX_STACK_LINE(357)
			::String _g14 = (_g13 + this->maxWidth);		HX_STACK_VAR(_g14,"_g14");
			HX_STACK_LINE(357)
			::String _g15 = (_g14 + HX_CSTRING("; "));		HX_STACK_VAR(_g15,"_g15");
			HX_STACK_LINE(357)
			::String _g16 = (_g15 + this->maxHeight);		HX_STACK_VAR(_g16,"_g16");
			HX_STACK_LINE(357)
			::String _g17 = (_g16 + HX_CSTRING(") and powerOfTwo: "));		HX_STACK_VAR(_g17,"_g17");
			HX_STACK_LINE(357)
			::String _g18 = ::Std_obj::string(this->powerOfTwo);		HX_STACK_VAR(_g18,"_g18");
			HX_STACK_LINE(357)
...
::flixel::graphics::atlas::FlxNode FlxAtlas_obj::expand( ::openfl::_v2::display::BitmapData data,::String key){
	...
	if (((this->root->right == null()))){
		...
		if (((bool((bool((bool(!(canExpandRight)) && bool(!(canExpandBottom)))) && bool(!(canExpandRightRotate)))) && bool(!(canExpandBottomRotate))))){
			HX_STACK_LINE(439)
			int _g30 = data->get_width();		HX_STACK_VAR(_g30,"_g30");
			HX_STACK_LINE(439)
			::String _g31 = (((HX_CSTRING("Can't insert node ") + key) + HX_CSTRING(" with the size of (")) + _g30);		HX_STACK_VAR(_g31,"_g31");
			HX_STACK_LINE(439)
			::String _g32 = (_g31 + HX_CSTRING("; "));		HX_STACK_VAR(_g32,"_g32");
			HX_STACK_LINE(439)
			int _g33 = data->get_height();		HX_STACK_VAR(_g33,"_g33");
			HX_STACK_LINE(439)
			::String _g34 = (_g32 + _g33);		HX_STACK_VAR(_g34,"_g34");
			HX_STACK_LINE(439)
			::String _g35 = (_g34 + HX_CSTRING(") in atlas "));		HX_STACK_VAR(_g35,"_g35");
			HX_STACK_LINE(439)
			::String _g36 = (_g35 + this->name);		HX_STACK_VAR(_g36,"_g36");
			HX_STACK_LINE(439)
			::String _g37 = (_g36 + HX_CSTRING(" with the max size of ("));		HX_STACK_VAR(_g37,"_g37");
			HX_STACK_LINE(439)
			::String _g38 = (_g37 + this->maxWidth);		HX_STACK_VAR(_g38,"_g38");
			HX_STACK_LINE(439)
			::String _g39 = (_g38 + HX_CSTRING("; "));		HX_STACK_VAR(_g39,"_g39");
			HX_STACK_LINE(439)
			::String _g40 = (_g39 + this->maxHeight);		HX_STACK_VAR(_g40,"_g40");
			HX_STACK_LINE(439)
			::String _g41 = (_g40 + HX_CSTRING(") and powerOfTwo: "));		HX_STACK_VAR(_g41,"_g41");
			HX_STACK_LINE(439)
			::String _g42 = ::Std_obj::string(this->powerOfTwo);		HX_STACK_VAR(_g42,"_g42");
			HX_STACK_LINE(439)
			HX_STACK_DO_THROW((_g41 + _g42));
			HX_STACK_LINE(441)
			return null();
		}
		HX_STACK_LINE(446)
		...
		if (((addBottomArea >= addRightArea))){
			...
			HX_STACK_LINE(499)
			int _g43 = ::Std_obj::_int(temp->rect->width);		HX_STACK_VAR(_g43,"_g43");
			HX_STACK_LINE(499)
			int _g44 = (_g43 + insertNodeWidth);		HX_STACK_VAR(_g44,"_g44");
			HX_STACK_LINE(499)
			int _g45 = ::Std_obj::_int(temp->rect->height);		HX_STACK_VAR(_g45,"_g45");
			HX_STACK_LINE(499)
			Float _g46 = ::Math_obj::max(_g45,insertNodeHeight);		HX_STACK_VAR(_g46,"_g46");
			HX_STACK_LINE(499)
			this->expandRoot(_g44,_g46,true,null());
			HX_STACK_LINE(500)
			::flixel::graphics::atlas::FlxNode _g47 = this->divideNode(this->root->right,insertNodeWidth,insertNodeHeight,true,data,key,rotateRight);		HX_STACK_VAR(_g47,"_g47");
			HX_STACK_LINE(500)
			dataNode = _g47;
			HX_STACK_LINE(501)
			...
			HX_STACK_LINE(511)
			int _g48 = ::Std_obj::_int(temp->rect->width);		HX_STACK_VAR(_g48,"_g48");
			HX_STACK_LINE(511)
			Float _g49 = ::Math_obj::max(_g48,insertNodeWidth);		HX_STACK_VAR(_g49,"_g49");
			HX_STACK_LINE(511)
			int _g50 = ::Std_obj::_int(temp->rect->height);		HX_STACK_VAR(_g50,"_g50");
			HX_STACK_LINE(511)
			int _g51 = (_g50 + insertNodeHeight);		HX_STACK_VAR(_g51,"_g51");
			HX_STACK_LINE(511)
			this->expandRoot(_g49,_g51,false,null());
			HX_STACK_LINE(512)
			::flixel::graphics::atlas::FlxNode _g52 = this->divideNode(this->root->right,insertNodeWidth,insertNodeHeight,true,data,key,rotateBottom);		HX_STACK_VAR(_g52,"_g52");
			HX_STACK_LINE(512)
			dataNode = _g52;
			HX_STACK_LINE(513)
...
::flixel::graphics::frames::FlxTileFrames FlxAtlas_obj::addNodeWithSpacings( Dynamic Graphic,::String Key,::flixel::math::FlxPoint tileSize,::flixel::math::FlxPoint tileSpacing,::flixel::math::FlxRect region){
	...
	if (((key == null()))){
		HX_STACK_LINE(584)
		HX_STACK_DO_THROW(HX_CSTRING("addNodeWithSpacings can't find the key for specified bitmapdata. Please provide not null value as a Key argument."));
		HX_STACK_LINE(586)
		return null();
	}
	HX_STACK_LINE(589)
	...
	if (((data == null()))){
		HX_STACK_LINE(599)
		::String _g2 = ::Std_obj::string(Graphic);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(599)
		::String _g3 = (HX_CSTRING("addNodeWithSpacings can't find bitmapdata with specified key: ") + _g2);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(599)
		HX_STACK_DO_THROW((_g3 + HX_CSTRING(". Please provide valid value.")));
		HX_STACK_LINE(601)
		return null();
	}
	HX_STACK_LINE(604)
	...
	if (((node == null()))){
		HX_STACK_LINE(610)
		::String _g4 = ::Std_obj::string(Graphic);		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(610)
		::String _g5 = (HX_CSTRING("addNodeWithSpacings can't insert provided image: ") + _g4);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(610)
		HX_STACK_DO_THROW((_g5 + HX_CSTRING(") in atlas. It's probably too big.")));
		HX_STACK_LINE(612)
		return null();
	}
	HX_STACK_LINE(615)
...
::flixel::graphics::atlas::FlxAtlas FlxAtlas_obj::addNodes( Array< ::Dynamic > bitmaps,Array< ::String > keys){
	...
	if (((numBitmaps != numKeys))){
		HX_STACK_LINE(693)
		HX_STACK_DO_THROW(((((HX_CSTRING("The number of bitmaps (") + numBitmaps) + HX_CSTRING(") should be equal to number of keys (")) + numKeys) + HX_CSTRING(")")));
		HX_STACK_LINE(695)
		return null();
	}
	HX_STACK_LINE(698)
	...
	if (((bool((value != this->powerOfTwo)) && bool((value == true))))){
		...
		if (((  ((!(((nextWidth != _g2))))) ? bool(_Function_2_1::Block(this,nextHeight)) : bool(true) ))){
			...
			if (((bool((bool((this->maxWidth > (int)0)) && bool((nextWidth > this->maxWidth)))) || bool((bool((this->maxHeight > (int)0)) && bool((nextHeight > this->maxHeight))))))){
				HX_STACK_LINE(1066)
				HX_STACK_DO_THROW(HX_CSTRING("Can't set powerOfTwo property to true, since it requires to increase atlas size which is bigger that max size"));
				HX_STACK_LINE(1068)
				return false;
			}
			HX_STACK_LINE(1071)
