...
class PlanetButton extends FlxUIGroup
{
	...
	public function new(X:Float=0, Y:Float=0, PlanetNo:Int, Parent:SubSurvey) 
	{
		...
		_back = new FlxUIButton(10, 0,  (Reg.game.planetsDiscovered[_planetNo] == -1 ? String.fromCharCode(65 + _planetNo) : Reg.game.positions[_planetNo] >= 10 ? "Wormhole" : Std.string(Reg.game.positions[_planetNo]+1)), SelectPlanet);
